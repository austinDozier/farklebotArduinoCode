...
void setup() {
  ...
  cupServo.attach(25);                 // attaches servo to pin
  ...
  stepperArm.setSpeed(600);           //RPM
  stepperTray.setSpeed(600);          //RPM
  i==0;
...
void cupTilt() {                   // Call comand to actuate Syringe Piston
  cupServo.write(150);                  // sets the servo position according to the scaled value
  delay(100);
}
  void cupReturn(){
  cupServo.write(100);            // adjust to fit strait up cup possition******************             
}
